...
const { registerEmployee, loginEmployee,  logoutEmployee, viewAllEmployees } = require('../controllers/employeeController.js')
...
//API endpoints
router.post('/registerEmployee', verifyToken, isSuperAdmin, registerEmployee) //Registers the Employee
router.post('/loginEmployee', loginEmployee)
router.get('/viewAllEmployees', verifyToken, isAdmin, viewAllEmployees)
